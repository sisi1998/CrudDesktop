...
public class ShowAllProdBackController implements Initializable {
    ...
    public Parent makeProduitModel(Produit produit) {
        Parent parent = null;
        try {
    ...
    private void ajouterProduit(ActionEvent ignored) {
        currentProduit = null;
        MainWindowBackController.getInstance().loadInterface(Constants.FXML_BACK_MANAGE_PRODUIT);
    }
